                    ...
                    <section className="header-section">
                        <div style={styles.rowInfoContainer}>
                            ...
                            <div style={styles.rowInfo}>
                                ...
                                <span style={styles.info}>{emergencies[0].requestList[0].eph_sexo}</span>
                            </div>
                            <div style={styles.rowInfo}>
                                <span style={styles.infoProp}>Idade: </span>
                                <span style={styles.info}>{emergencies[0].requestList[0].eph_idade}</span>
                            </div>

                            {/* Estado Consciência with checkboxes */}
                            <div style={styles.rowInfo}>
                                <span style={styles.infoProp}>Estado Consciência: </span>
                                <div style={styles.info}>
                                    <label style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                                        ...
                                        <Checkbox
                                            ...
                                            checked={emergencies[0].requestList[0].eph_ec_consciente === 1}
                                        />
                                    </label>
                                    <label style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                            ...
                            {/* Sinais e Sintomas and Observações in new row */}
                            <div style={{ display: 'flex', flexDirection: 'column', marginTop: '10px' }}>
                                <div style={styles.rowInfo}>
                                    <span style={styles.infoProp}>Sinais e Sintomas: </span>
                                    <span style={styles.info}>{emergencies[0].requestList[0].sinais_sintomas}</span>
                                </div>
                                <div style={styles.rowInfo}>
                                    <span style={styles.infoProp}>Observações: </span>
...
export default EPH_RequestComponent;
